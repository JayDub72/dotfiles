...
running "Set highlight color to blue"
defaults write NSGlobalDomain AppleHighlightColor -string "0.175668 0.326138 0.589803";ok
...
running "Set User directory as the default location for new Finder windows"
...
bot "Dock & Dashboard"
###############################################################################
running "Moving dock to the left side of the screen"
